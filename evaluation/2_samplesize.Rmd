...
In Figure \@ref(fig:figrapportage) we show the estimated habitat proportions with bad quality as reported in 2019. This reporting was based on the plots that were measured in the period 2014 - 2018. This means that only a subset of the total sample size was measured at that time, as the total monitoring cycle was 12 years. Only for the more common forest habitat types we already reached the total sample size, as we could make use of the measurements of the Flemish Forest Inventory.
...
Suppose that the net proportion with bad quality decreases with 10 %, then the dynamics are equal to 2 when 15% of the habitat area changes from good to bad and 5% of the habitat area from bad to good. The higher the dynamics, the smaller the minimal delectable difference.
